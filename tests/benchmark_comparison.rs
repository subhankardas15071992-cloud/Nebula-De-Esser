...
mod benchmark_tests {
    ...
    fn test_loudness_consistency() {
        ...
        assert!(
            loudness_before > -50.0 && loudness_before < 0.0,
            "Test signal loudness should be reasonable: {} dB",
            loudness_before
        );
    }
    ...
    fn test_transient_integrity() {
        ...
        assert!(
            crest_before > 2.0,
            "Transient should have high crest factor: {}",
            crest_before
        );
    }
    ...
    fn test_harmonic_preservation() {
        ...
        assert!(
            loudness > -20.0,
            "Harmonic signal should have reasonable loudness"
        );
    }
    ...
    fn test_dynamic_responsiveness() {
        ...
        assert!(
            loudness2 > loudness1,
            "Middle section should be louder than beginning"
        );
        assert!(
            loudness2 > loudness3,
            "Middle section should be louder than end"
        );
    }
    ...
    fn test_stereo_image_coherence() {
        ...
        assert!(
            ...
            "Left channel should be louder: L={}, R={}",
            left_loudness,
            right_loudness
        );
        ...
        assert!(
            diff < 6.0,
            "Stereo channels should be reasonably balanced: {} dB diff",
            diff
        );
    }
    ...
    fn test_temporal_smoothness() {
        ...
        assert!(
            max_diff < 0.1,
            "Signal should be temporally smooth: max diff={}",
            max_diff
        );
    }
    ...
    fn test_performance_benchmark() {
        ...
        for &size in &buffer_sizes {
            ...
            assert!(
                samples_per_second > 44100.0 * 10.0,
    ...
    fn test_parameter_automation_smoothness() {
        ...
        assert!(
            max_change < 0.05,
            "Parameter automation too abrupt: max change={}",
            max_change
        );
    }
    ...
    fn test_industry_standard_comparison() {
        ...
        assert!(
            max_latency_samples <= 441,
            "Latency should be under 10ms ({} samples max)",
            max_latency_samples
        );
    ...
    fn test_ui_responsiveness() {
        ...
        assert!(
            max_parameter_update_ms < frame_time_ms,
    ...
    fn test_clap_compliance() {
        ...
        let required_parameter_features = ["automation", "modulation", "presets", "state"];
