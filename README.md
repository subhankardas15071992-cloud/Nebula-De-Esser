...
So if you are a Cakewalk Sonar or NXT user, this plugin is not for you and it won't be fixed for your DAW in near future either. And it's not just about Cakwalk Sonar or NXT, any DAW that doesn't adheres to Steiberg's established VST3 standards and doesn't use a stable thread safety standards won't be supported by this plugin. It is not the plugins problem that the DAW has such a shoddy plugin managment.
