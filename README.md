...
**This plugin will not work in Cakewalk NXT and Cakewalk Sonar. This is a known, confirmed incompatibility. And here's the explanation**
...
Buffer pointers 8-byte aligned for `f64` DSP	JUCE wrapper may pass 4-byte aligned `float*` buffers	Misaligned access → SIGSEGV on Apple Silicon<img width="1068" height="111" alt="image" src="https://github.com/user-attachments/assets/4f0d1c9c-b3c1-4b56-bb1f-a741e52d4e34" />
